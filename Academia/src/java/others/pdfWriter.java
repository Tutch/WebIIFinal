...
//    createTableExercicios(subCatPart);
  ...
  public static void addNumbers(Document document, int alunos, int professores, int exercicios, int fichas) throws DocumentException{
    ...
    addEmptyLine(numbers, 1);
    // Will create: Report generated by: _name, _date
    numbers.add(new Paragraph("Alunos Cadastrados: " + alunos,
        smallBold));
